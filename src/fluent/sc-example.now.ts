...
const topicComputer = '01a497a7c3053010069aec4b7d40dd14'
const topicSoftware = Record({
    ...
    data: {
        ...
        active: true,
        sys_domain: 'global',
        apply_to_child_topics: false,
        available_for: '',
        enable_user_criteria_check: false,
        not_available_for: '',
        topic_based_navigation: false,
        topic_contributor: '',
        topic_manager: '',
    },
})
...
export const pricedDeveloperWorkstation = CatalogItem({
    ...
    variables: {
        ...
        laptopType: SelectBoxVariable({
            ...
            mandatory: true,
            choices: {
                standard: { label: 'Standard Business Laptop', inactive: false, sequence: 0 },
                performance: { label: 'Performance Laptop (Development/Design)', inactive: false, sequence: 0 },
                executive: { label: 'Executive Laptop', inactive: false, sequence: 0 },
                workstation: { label: 'Mobile Workstation', inactive: false, sequence: 0 },
            },
            defaultValue: 'standard',
            tooltip: 'Select the type of laptop based on your',
        }),
    },
    notAvailableFor: ['66c1b50e730333009508738234f6a7c9'],
})
...
export const softwareInstallation = CatalogItem({
    ...
    notAvailableFor: [userCriteriaDevDepartment, '66c1b50e730333009508738234f6a7c9'],
    variableSets: [
